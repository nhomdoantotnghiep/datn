...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#send").click(function(){
            ...
            if(favorite){
                console.log("lttaijq--"+favorite.join("/"));
                var v_room = favorite.join("/");
...
<!--<a href="NewServlet?pageNumber=<%=pageNumbers.get(i)%>"><%=pageNumbers.get(i)%></a>-->
        ...
        <table cellpadding="1px" border="0" cellspacing="1px"  width="950px" align="center">  
            ...
            <td colspan="8" align="center">
                <input type="button" name="send" id="send" class="button_example" value="Send Complaint"  />
