...
<%@page import="typeaccess.classTypeAccess"%>
        ...
        <script type="text/javascript">
            ...
            function lookup(txtName, ID) {
                if (txtName.length < 1) {
                    ...
                    $.post("../checkNameEdit", {name: "" + txtName + "", tID: "" + ID + ""}, function(data) {
        ...
        <script type="text/javascript">
            ...
            function lookupCreate(txtuser) {
                if (txtuser.length < 1) {
                    ...
                    $.post("../checkTypeNameCreate", {namecreate: "" + txtuser + ""}, function(data) {
                        $('#autoSuggestionsList').html(data).show();
                    });
                }
            }
        ...
        <script type="text/javascript">
            ...
            function show(pagenumber,status) {
                ...
                if (xmlHttpRe) {
                    ...
                    xmlHttpRe.open("GET", "../showTypeAccess?pageNumber=" + getText+strStatus+"&typeName"+v_typeName, true);// chú ý
            ...
            function goPage(status)
            {
                ...
                if (xmlHttpRe) {
                    ...
                    xmlHttpRe.open("GET", "../showTypeAccess?pageNumber=" + c_value+strStatus+"&typeName"+v_typeName, true);// chú ý
                    xmlHttpRe.onreadystatechange = handleResponse;
                    xmlHttpRe.send(null);
                }
            }
            function Search()
            {
                ...
                if (xmlHttpRe) {
                    ...
                    xmlHttpRe.open("GET", "../showTypeAccess?typeName=" + v_typeName + "&status=" + v_status, true);// chú ý
                    xmlHttpRe.onreadystatechange = handleResponse;
                    xmlHttpRe.send(null);
                }
            }
...
<!--<a href="NewServlet?pageNumber=<%=pageNumbers.get(i)%>"><%=pageNumbers.get(i)%></a>-->
                ...
                <%
                    ...
                    if(request.getParameter("typeName")!=null){
                        typeN="&typeName="+request.getParameter("typeName");
                    }
                    for (int i = 0; i < list.size(); i++) {
                %>  
                <tr>  
                    <%
                        classTypeAccess studentDetailsDTO = (classTypeAccess) list
                                .get(i);
                        if (i % 2 == 0) {
                    ...
                    <td align='center' style="height:30px;width: 40px;"><a href="?options=ManagerTypeAccessory"><img src="../img/back.png" width="23px" height="20px" /></a></td>
                            <%
                            } else {
                            %>
                    <td align='center' style="height:30px;width: 40px;">
                        <a href="?options=ManagerTypeAccessory<%=typeN %><%=statusN%>&pageNumber=<%=pageSelected %>&tID=<%=studentDetailsDTO.getTypeID()%>"><img src="../img/edit.png" width="23px" height="23px" /></a>
                    </td>
                    <td align='center' style="height:30px;width: 40px;">
                    ...
                    <td align='center' style="height:30px;background: #e7f5fe;width: 40px;"><a href="?options=ManagerTypeAccessory"><img src="../img/back.png" width="23px" height="20px" /></a></td>
                            <%
                            } else {
                            %>
                    <td align='center' style="height:30px;background: #e7f5fe;width: 40px;">
                    ...
                    <td colspan="4" align="center">
                        <table>
                            <tr>
                                ...
                                <td><input style="<%=visibly %>" title="Delete" type="submit"  name="delete" onclick="BASIC_SelectItem('create', 0)" class="button_example" height="20px" value="Create" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
