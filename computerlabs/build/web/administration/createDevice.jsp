...
<form id='ajaxform' name='ajaxform' method='post'>
    <table width="500px" border="0" align="center" cellpadding="7px" cellspacing="0">
        ...
        <tr>
            <td colspan="2">
                <textarea rows="5" placeholder="Please enter description..." style="width: 500px; border:1px solid #d1d1d1;-moz-border-radius: 5px;-webkit-border-radius: 5px;" name="txtDes"></textarea>

            </td>
        </tr>
        <tr>
            <td colspan="2">
                <input type="submit" value="     Create       " onclick="mySubmit();" class="button_example"  />
        ...
        <tr>
            <td colspan="2">
                <input type="hidden" placeholder="gan"  value="" id="txtResultAccess" name="txtResultAccess" />
                <input type="hidden"  placeholder="tam"  value="<%=request.getParameter("listcheck") == null ? "" : request.getParameter("listcheck")%>" id="txtList" name="txtList" />
            </td>
        </tr>
