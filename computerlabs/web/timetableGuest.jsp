...
<script type="text/javascript">
    ...
    function show(pagenumber) {
        ...
        if (xmlHttpRe) {
            ...
            xmlHttpRe.open("GET", "showScheGuest?pageNumber=" + getText + "&roomid=" + v_room + "&inputdateTo=" + v_dateTo + "&inputdateFrom=" + v_dateFrom + "&shiftType=" + v_shift, true);// chú ý
    ...
    function goPage()
    {
        ...
        if (xmlHttpRe) {
            ...
            xmlHttpRe.open("GET", "showScheGuest?pageNumber=" + c_value + "&roomid=" + v_room + "&inputdateTo=" + v_dateTo + "&inputdateFrom=" + v_dateFrom + "&shiftType=" + v_shift, true);// chú ý
            xmlHttpRe.onreadystatechange = handleResponse;
            xmlHttpRe.send(null);
        }
    }
    function Search()
    {
        ...
        if (xmlHttpRe) {
            ...
            xmlHttpRe.open("GET", "showScheGuest?roomid=" + getText + "&inputdateTo=" + v_dateTo + "&inputdateFrom=" + v_dateFrom + "&shiftType=" + getShift, true);// chú ý
            xmlHttpRe.onreadystatechange = handleResponse;
            xmlHttpRe.send(null);
        }
    }
            ...
            for (int j = 0; j <= (strGetStatus.length - 1); j++) {
                ...
                if (Integer.parseInt(strGetStatus[j].trim()) == 1) {
                    ...
                    if (check.checkStatusRequest(Integer.parseInt(strGetID[j])) == 2) {
                        ...
                        out.println("<td style='background: #ececec;height:30px' align=\"center\"><img src=\"img/available.png\"  /></td>");
                    } else {
                        out.println("<td style='background: #ececec;height:30px' align=\"center\"><img src=\"img/available.png\"  /></td>");
                    }
