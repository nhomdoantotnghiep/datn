...
import processSchedule.classRequest;

/**
 *
 * @author User
 */
public class scheduleDetailsClient extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        TestList(offset, maxEntriesPerPage, txtSearchName, txtFullName, txtClassName, status, userID);

        httpSession.setAttribute("pages", getPages());
        httpSession.setAttribute("scheRequest", getListByOffsetAndLength());

        RequestDispatcher dispatcher = request
                .getRequestDispatcher("scheDetailsClient.jsp");  //link
     ...
     * such as a database 
     */
    public void fillList( String searchUser, String searchFullname, String searchClassName, int searchStatus, int userID) {
        list = new ArrayList();
        Connection cnn = null;
        Statement st = null;
        ResultSet rs = null;
     ...
     * @param length
     */
    public void TestList(int offset, int length, String userN, String fullN, String ClassN, int RStatus, int userID) {
        this.offset = offset;
        this.length = length;
        fillList( userN, fullN, ClassN, RStatus, userID);
    }
