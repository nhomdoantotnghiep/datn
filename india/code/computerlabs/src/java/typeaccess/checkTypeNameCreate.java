 ...
 * @author User
 */
public class checkTypeNameCreate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String str = request.getParameter("namecreate");
            CheckUsername check=new CheckUsername();
            int result=check.checkUsername(str,"tbl_type_accessory","type_accessory","");
            if (result == 1) {
