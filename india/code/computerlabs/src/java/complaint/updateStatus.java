    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         if(request.getParameter("statusUp")!=null){
             try{
             statusUp=Integer.parseInt(request.getParameter("statusUp").toString().trim());
             }catch(Exception ex){
                 statusUp=0;
             }
         }
         ...
         if(complaintID>0){
             Connection cnn=null;
             Statement st=null;
             String sql="update tbl_complaint set [status]="+statusUp+" where complaintID="+complaintID;
